...
public class Cinturon : MonoBehaviour{
	...
	void Start ()
	{
		cinturon = PlayerPrefs.GetString("cinturon");

		if(cinturon == "cinturon1")
		{
			item = 1;
		}
		if(cinturon == "cinturon2")
		{
			item = 2;
		}
	}
	...
	void Update ()
	{
		...
		if(PlayerPrefs.GetString("cinturon") == compra)
		{
			selecB.SetActive(false);
		}

		//--------------SET ON CUSTODE-----------
		customTow.cinturon = compra;
	}
	...
	public void select ()
	{
		PlayerPrefs.SetString("cinturon",compra);
	}
	//COMPRAR CON COINS
